...
import { Dialog, Menu, Popover, Tabs, Tooltip } from "monochrome/remix";
...
export default function Fixture() {
  return () => (
    <>
      ...
      <Dialog.Root>
        <Dialog.Trigger data-testid="autofocus-trigger">Open autofocus</Dialog.Trigger>
        <Dialog.Content>
      ...
      <Dialog.Root>
        <Dialog.Trigger data-testid="tabs-dialog-trigger">Open tabs dialog</Dialog.Trigger>
        <Dialog.Content>
          <Dialog.Title>Tabs dialog</Dialog.Title>
          <Dialog.Description>Switching tabs should update the focus trap.</Dialog.Description>
