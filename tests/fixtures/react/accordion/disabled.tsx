  ...
  <>
    ...
    <Accordion.Root type="single" data-testid="disabled-accordion">
      <Accordion.Item data-testid="disabled-item-1">
        <Accordion.Header>
          <Accordion.Trigger data-testid="disabled-trigger-1">Section 1</Accordion.Trigger>
        </Accordion.Header>
        <Accordion.Panel data-testid="disabled-content-1">
      ...
      <Accordion.Item disabled data-testid="disabled-item-2">
        ...
        <Accordion.Panel data-testid="disabled-content-2">
          <p>Content for section 2 (disabled)</p>
        </Accordion.Panel>
      </Accordion.Item>
      <Accordion.Item data-testid="disabled-item-3">
        <Accordion.Header>
          <Accordion.Trigger data-testid="disabled-trigger-3">Section 3</Accordion.Trigger>
        </Accordion.Header>
        <Accordion.Panel data-testid="disabled-content-3">
