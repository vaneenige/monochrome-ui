...
<template>
  <div>
    ...
    >
      ...
      <Tabs.Panel
        value="svgtab1"
        data-testid="svg-panel-1"
      >
        <p>SVG Tab 1 content</p>
      </Tabs.Panel>
      <Tabs.Panel
        value="svgtab2"
        data-testid="svg-panel-2"
      >
        <p>SVG Tab 2 content</p>
      </Tabs.Panel>
    </Tabs.Root>
    <Tabs.Root
      default-value="search1"
      data-testid="search-tabs-container"
    >
      <Tabs.List data-testid="search-tablist">
        <Tabs.Tab
          value="search1"
          data-testid="search-tab-1"
        >
          Search Tab 1
        </Tabs.Tab>
        <Tabs.Tab
          value="search2"
          data-testid="search-tab-2"
        >
          Search Tab 2
        </Tabs.Tab>
      </Tabs.List>
      <Tabs.Panel
        value="search1"
        data-testid="search-panel-1"
      >
        <p>First panel content</p>
      </Tabs.Panel>
      <Tabs.Panel
        value="search2"
        data-testid="search-panel-2"
      >
