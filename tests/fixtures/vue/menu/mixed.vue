...
<template>
  <div style="padding: 2rem; display: flex; gap: 300px; align-items: flex-start">
    <Menu.Root>
      <Menu.Trigger data-testid="dropdown-trigger">
        Dropdown
      </Menu.Trigger>
      <Menu.Popover data-testid="dropdown-list">
        <Menu.Item data-testid="dropdown-item-1">
          Item 1
        </Menu.Item>
        <Menu.Item data-testid="dropdown-item-2">
          Item 2
        </Menu.Item>
      </Menu.Popover>
    </Menu.Root>
    <Menubar.Root data-testid="menubar-a-list">
      <Menubar.Menu>
        ...
        <Menubar.Popover data-testid="menubar-a-list-1">
          <Menubar.Item data-testid="menubar-a-item-1-1">
            A1.1
          </Menubar.Item>
        </Menubar.Popover>
      </Menubar.Menu>
      <Menubar.Menu>
        ...
        <Menubar.Popover data-testid="menubar-a-list-2">
          <Menubar.Item data-testid="menubar-a-item-2-1">
            A2.1
          </Menubar.Item>
        </Menubar.Popover>
      </Menubar.Menu>
    ...
    <Menubar.Root data-testid="menubar-b-list">
      <Menubar.Menu>
        ...
        <Menubar.Popover data-testid="menubar-b-list-1">
          <Menubar.Item data-testid="menubar-b-item-1-1">
            B1.1
          </Menubar.Item>
        </Menubar.Popover>
      </Menubar.Menu>
      <Menubar.Menu>
        ...
        <Menubar.Popover data-testid="menubar-b-list-2">
          <Menubar.Item data-testid="menubar-b-item-2-1">
            B2.1
          </Menubar.Item>
        </Menubar.Popover>
      </Menubar.Menu>
