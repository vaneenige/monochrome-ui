...
export const MenubarSlotKey: InjectionKey<MenubarSlotContext> = Symbol("MenubarSlotContext");

export type MenubarClaimContext = {
  claimFirst: (id: string) => boolean;
  release: (id: string) => void;
};
export const MenubarClaimKey: InjectionKey<MenubarClaimContext> = Symbol("MenubarClaimContext");
